...
export default function FiturProdi1Page() {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <p className="text-gray-600 mb-4">
          Ini adalah contoh fitur yang dapat diakses oleh Ketua Program Studi.
          Fitur ini memiliki akses ke data mahasiswa dan dosen sesuai program
          studi masing-masing.
        </p>
