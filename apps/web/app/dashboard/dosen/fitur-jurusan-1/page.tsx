      ...
      <div className="grid gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-sm text-gray-500">
              Jumlah minimal bimbingan yang harus diselesaikan sebelum mahasiswa
              dapat mendaftar sidang
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-medium text-gray-700">
                Batas Waktu Revisi (Hari)
              </label>
              <input
                type="number"
                min="1"
                value={pengaturan.batas_revisi_hari}
                onChange={(e) =>
                  setPengaturan({
                    ...pengaturan,
                    batas_revisi_hari: parseInt(e.target.value) || 1,
                  })
                }
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-900 focus:border-transparent"
              />
              <p className="text-sm text-gray-500">
                Batas waktu pengumpulan revisi setelah sidang
              </p>
            </div>
          </div>
        </div>
