...
export default function FiturJurusan2Page() {
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center space-x-3 mb-4">
          <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center">
            <FileCheck className="w-6 h-6 text-red-900" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              Fitur Khusus Jurusan 2
            </h1>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <p className="text-gray-600 mb-4">
          Ini adalah contoh fitur kedua yang hanya dapat diakses oleh Ketua
          Jurusan. Fitur ini dapat digunakan untuk manajemen dan monitoring
          seluruh aktivitas akademik di tingkat jurusan.
        </p>
