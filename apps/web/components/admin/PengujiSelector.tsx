...
interface PengujiSelectorProps {
  ...
  onChange: (value: { penguji1Id: number | null; penguji2Id: number | null; penguji3Id: number | null }) => void;
}
...
export function PengujiSelector({ value, onChange }: PengujiSelectorProps) {
  ...
  useEffect(() => {
    const ids = [value.penguji1Id, value.penguji2Id, value.penguji3Id].filter(Boolean);
    ...
    <div className="space-y-4">
      <div>
        ...
        <select
          ...
          onChange={(e) => onChange({ ...value, penguji1Id: e.target.value ? parseInt(e.target.value) : null })}
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) => onChange({ ...value, penguji2Id: e.target.value ? parseInt(e.target.value) : null })}
          className="w-full px-3 py-2 border rounded-lg"
        >
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) => onChange({ ...value, penguji3Id: e.target.value ? parseInt(e.target.value) : null })}
          className="w-full px-3 py-2 border rounded-lg"
        >
