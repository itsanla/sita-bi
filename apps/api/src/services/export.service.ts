...
export class ExportService {
  ...
  async generateJadwalSidangPdf(): Promise<Buffer> {
    try {
      ...
      console.error('[ExportService] Error generating jadwal sidang PDF:', error);
      throw new Error('Gagal membuat PDF jadwal sidang');
    }
  }
  ...
  async generateJadwalSidangExcel(): Promise<Buffer> {
    try {
      ...
      console.error('[ExportService] Error generating jadwal sidang Excel:', error);
      throw new Error('Gagal membuat Excel jadwal sidang');
    }
  }
  ...
  async generateRekapNilaiExcel(): Promise<Buffer> {
    try {
      ...
      console.error('[ExportService] Error generating rekap nilai Excel:', error);
      throw new Error('Gagal membuat Excel rekap nilai');
    }
  }
  ...
  async generateUsersExcel(): Promise<Buffer> {
    try {
      ...
      console.error('[ExportService] Error generating users Excel:', error);
      throw new Error('Gagal membuat Excel data pengguna');
    }
  }
  ...
  async generateBeritaAcaraPdf(sidangId: number): Promise<Buffer> {
    try {
      ...
      if (!sidang) {
        throw new Error('Sidang tidak ditemukan');
      }
      ...
      console.error('[ExportService] Error generating berita acara PDF:', error);
      if (error instanceof Error && error.message === 'Sidang tidak ditemukan') {
        throw error;
      }
      throw new Error('Gagal membuat PDF berita acara');
    }
  }
}
